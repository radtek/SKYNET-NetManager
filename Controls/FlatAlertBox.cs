...
internal class FlatAlertBox : Control
{
    ...
    public FlatAlertBox()
    {
        ...
        PersonalizadoColor = Color.FromArgb(43, 47, 48); //Color del Panel  
        PersonalizadoText = Color.FromArgb(7, 164, 245); //Color del texto

        ErrorColor = Color.FromArgb(147, 157, 160);
                ...
                case _Kind.Personalizado:
                    {
                        ...
                        g.FillEllipse(new SolidBrush(Color.FromArgb(57, 62, 63)), new Rectangle(W - 30, H - 29, 17, 17)); //Circulito de cerrar
                        ...
                        if (state2 == MouseState.Over)
                        {
                            ...
                            g.DrawString("r", new Font("Marlett", 8f), new SolidBrush(Color.FromArgb(57, 62, 63)), new Rectangle(W - 28, 16, W, H), Helpers.NearSF); //Crucecita de cerrar
                        }
                        break;
                    }
            }
