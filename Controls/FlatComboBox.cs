...
public class FlatComboBox : ComboBox
{
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        checked
        {
            ...
            g.FillRectangle(new SolidBrush(Color.FromArgb(57, 62, 63)), rect2); // Color del cuadro a la derecha
            g.ResetClip();
            g.DrawLine(Pens.White, W - 10, 6, W - 30, 6);
            g.DrawLine(Pens.White, W - 10, 12, W - 30, 12);
            g.DrawLine(Pens.White, W - 10, 18, W - 30, 18);
            g.DrawString(Text, Font, new SolidBrush(ForeColor), new Point(4, 3), Helpers.NearSF);
            Helpers.G.Dispose();
            e.Graphics.InterpolationMode = InterpolationMode.HighQualityBicubic;
